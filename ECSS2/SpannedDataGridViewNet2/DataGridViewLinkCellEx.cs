...
{
    public class DataGridViewLinkCellEx : DataGridViewLinkCell, ISpannedCell
    {
        #region Fields
        ...
        protected override Rectangle BorderWidths(DataGridViewAdvancedBorderStyle advancedBorderStyle)
        {
            ...
            var rightBottomCell = DataGridView[
                ...
                RowIndex + RowSpan - 1] as DataGridViewLinkCellEx;
    ...
    public class DataGridViewLinkColumnEx : DataGridViewColumn
    {
        #region ctor
        public DataGridViewLinkColumnEx()
            : base(new DataGridViewLinkCellEx())
        {
        }
        #endregion
    }
